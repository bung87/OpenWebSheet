...
describe('ColorPicker', () => {
  ...
  it('should use the prop value for input value', () => {
    ...
    expect((wrapper.find('[data-qa=input-el]').element as HTMLInputElement).value).toBe('#00ff00');
  });
  ...
  it('should use WHITE when the value is null', () => {
    ...
    expect((wrapper.find('[data-qa=input-el]').element as HTMLInputElement).value).toBe('#ffffff');
  });
